...
var sendTradeInfo = function (order, socket_id, extraParam, event_name) {
    ...
    order.seller_username = null;//nullify - we should not send it for security reason - may go to the peer trader (buyer in this case).
    order.buyer_username = null;//nullify - we should not send it for security reason - may go to the peer trader (seller in this case).
