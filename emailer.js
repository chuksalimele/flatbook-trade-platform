...
var openLiveAcctHtml = function(){
 return`<p>Your account balance has been updated accordingly.</p>
            <p>Open a <a href="${ sObj.config.LIVE_ACCOUNT_LINK}">live account</a> now!</p>
...
var RegisterationHtml = function (fullname, username, password) {
    return `<p>Dear ${fullname? fullname:"Customer"},</p>
...
var RecoverPasswordHtml = function (fullname, username, password) {
    return `<p>Dear ${fullname? fullname:"Customer"},</p>

            <p>
            We have received your request to recover your password.
            <br/>  
            Your login credentials is as follows:
            </p>
            <p>
            Username: ${username}</br>
            Password: ${password}</br>
            ...
            <p>
             We recommend that you always keep your password safe.
             </br>
...
var SpotFxDemoOrderDetailsHtml = function (order) {
    ...
    eh.header(`<p>Dear Customer,</p>
               <p>Your Spot FX demo order details executed on ${order.time} are as follows:</p>`);
...
var SpotFxDemoOrderSettledHtml = function (order) {
    ...
    eh.header(`<p>Dear Customer,</p>
               <p>Your Spot FX demo order has settled on ${order.time} and the details are as follows:</p>`);
...
var OptionsDemoOrderDetailsdHtml = function (order) {
    ...
    eh.header(`<p>Dear Customer,</p>
               <p>Your Options demo order details executed on ${order.time} are as follows:</p>`);
...
var OptionsDemoOrderSettledHtml = function (order) {
    ...
    eh.header(`<p>Dear Customer,</p>
               <p>Your Options demo order has settled on ${order.time} and the details are as follows:</p>`);
