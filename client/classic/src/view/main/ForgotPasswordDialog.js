...
Ext.define('TradeApp.view.main.ForgotPasswordDialog', {
    ...
    items: [{
            ...
            items: [{
                    xtype: 'component',
                    html: '<div><strong>No Stress!</strong> <br/>We can help you recover your password.<br/> Just enter your username below and we shall send you an email to recover your password via the email address you provided to us during registration.</div>',
                    flex: 1
                }, {
                    xtype: 'textfield',
                    allowBlank: false,
