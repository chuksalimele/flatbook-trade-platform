    ...
    defaults: {
            ...
            menu: [
                /*UP COMING FEATURE - UNCOMENT WHEN FEATURE IS NEEDED
                 ...
                 xtype: 'menuseparator'
                    ...
                    handler: function () {
                        document.getElementById('center-view-pan-btn').click();
                    }
                }, {
                    text: 'Zoom chart',
                    //iconCls: 'fa fa-zoom',//TODO
                    handler: function () {
                        document.getElementById('center-view-zoom-btn').click();
                    }
                }, {
                    text: 'Reset chart',
                    //iconCls: 'fa fa-reset',//TODO
                    handler: function () {
                        document.getElementById('center-view-reset-zoom-pan-btn').click();
                    }
                }
                /*UP COMING FEATURE - UNCOMENT WHEN FEATURE IS NEEDED
                 , {
         ...
         },*/
        {
            ...
            items: [{
                    text: 'Pan',
                    pressed: false,
                    id: 'center-view-pan-btn',
                    //iconCls: 'fa fa-hand-stop-o',//TODO
                    handler: 'onChartPan'
                }, {
                    text: 'Zoom',
                    pressed: false,
                    id: 'center-view-zoom-btn',
                    //iconCls: 'fa fa-zoom',//TODO
                    handler: 'onChartZoom'
                }, {
                    text: 'Reset',
                    pressed: true,
                    id: 'center-view-reset-zoom-pan-btn',
                    //iconCls: 'fa fa-reset',//TODO
